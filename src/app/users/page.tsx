...
const Users = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        console.log("some error occurred in fetching user data", e);
      }
    };
  ...
  return (
    <div>
      ...
      <h1 className="text-3xl text-center mt-18 mb-5">
        {" "}
        <u>Users List </u>
      </h1>
      <table className="table-fixed mx-auto border-separate border-spacing-2 border border-gray-400 dark:border-gray-500">
        <thead>
          <tr>
